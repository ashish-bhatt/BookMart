...
class Books extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('bookname', 'length', 'max'=>100),
			array('author', 'length', 'max'=>50),
			array('price', 'length', 'max'=>2),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('bookid, bookname, author, price', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bookdatas' => array(self::HAS_MANY, 'Bookdata', 'id'),
			'carts' => array(self::HAS_MANY, 'Cart', 'prodid'),
		);
	}
